...
<body>
        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <h1 class="h5 m-0 font-weight-bold text-center w-100 text-dark">
                    <span
                        style="font-size: 1.1rem; font-weight: 600; padding-bottom: 5px; display: inline-block; line-height: 1.5;">ShopeePay</span>
                </h1>
    ...
    <div class="container" style="padding-top: 55px; padding-bottom: 100px;">
        ...
        <div class="d-flex justify-content-center align-items-center py-4">
            ...
            <div class="d-flex justify-content-center align-items-center rounded"
                style="width: 100px; height: 100px; margin: 0 10px; padding: 10px;">
                <img src="assets/img/e-wallete/shopee.svg" alt="ShopeePay Logo" class="img-fluid">
            </div>
        </div>
