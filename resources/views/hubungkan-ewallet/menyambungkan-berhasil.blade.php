...
<head>
    ...
    <title>Menyambungkan Berhasil</title>
    ...
    <link rel="stylesheet" href="css/hubungkan-ewallet/menyambungkan-ewallet-berhasil.css">
</head>

<body class="bg-white">

    <div class="container success-card text-center d-flex flex-column justify-content-center align-items-center">
        ...
        <h5 class="font-weight-bold mb-2 Poppins">Selamat!</h5>

        <p class="mb-1">Berhasil Menyambungkan E-wallet</p>
