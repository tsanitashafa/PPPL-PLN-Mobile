...
<body>
  <div class="container mt-4">
    ...
    <h1>Masukkan kode verifikasi yang kami kirim ke email <span class="text-info fw-bold">duyung@gmail.com</span></h1>
  ...
  <a href="{{ route('createpin') }}" class="btn btn-continue">Continue</a>
